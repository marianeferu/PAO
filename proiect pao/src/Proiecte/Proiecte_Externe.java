...
public class Proiecte_Externe extends  Proiecte{


    private String locatie;
    private Integer cheltuieli;   ///transport

    public Proiecte_Externe(String data, Integer suma_alocata, String nr_participanti, String id_coordonator, String denumire, String locatie, Integer cheltuieli) {
